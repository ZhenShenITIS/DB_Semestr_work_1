...
create table if not exists autoservice_schema.branch_office
(
...
create table if not exists autoservice_schema.worker
(
    id               SERIAL PRIMARY KEY,
...
create table if not exists autoservice_schema.provider
(
    id           SERIAL PRIMARY KEY,
    address      VARCHAR,
...
create table if not exists autoservice_schema.customer
(
    id           SERIAL PRIMARY KEY,
    full_name    VARCHAR NOT NULL,
    phone_number VARCHAR NOT NULL
...
create table if not exists autoservice_schema.purchase
(
    id          SERIAL PRIMARY KEY,
...
create table if not exists autoservice_schema.order
(
    id            SERIAL PRIMARY KEY,
...
create table if not exists autoservice_schema.box
(
    id               SERIAL PRIMARY KEY,
    id_branch_office INT REFERENCES autoservice_schema.branch_office (id) NOT NULL,
...
create table if not exists autoservice_schema.car
(
...
create table if not exists autoservice_schema.task
(
    id          SERIAL PRIMARY KEY,
...
create table if not exists autoservice_schema.autopart
(
    id          SERIAL PRIMARY KEY,
...
create table if not exists autoservice_schema.order_car
(
    order_id INT REFERENCES autoservice_schema.order (id)    NOT NULL,
    car_id   VARCHAR REFERENCES autoservice_schema.car (vin) NOT NULL
);

create table if not exists autoservice_schema.payout
(
    id          SERIAL PRIMARY KEY,
    value       INT                                           NOT NULL,
    date        TIMESTAMP WITHOUT TIME ZONE                   NOT NULL,
